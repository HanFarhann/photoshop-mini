...
def show_image(image, caption="", stretch=True, px_width=None):
    ...
    if px_width is not None:
        st.image(image, caption=caption, width=px_width, use_container_width=True)
    else:
...
if uploaded_file:
    try:
        ...
        # === 3. Image Brightening ===
            ...
            brightness = st.slider("Atur kecerahan", 0.0, 3.0, 1.0, 0.1, key="brightness_slider")
        ...
        # === 4. Operasi Aritmetika Dua Citra ===
            ...
            if second_file:
                ...
                op = st.selectbox("Pilih operasi:", ["Tambah", "Kurang", "Rata-rata"], key="arit_op")
        ...
        # === 5. Operasi Boolean Dua Citra ===
            ...
            if second_file:
                ...
                op = st.selectbox("Pilih operasi Boolean:", ["AND", "OR", "XOR"], key="bool_op")
        ...
        # === 6. Operasi Geometri ===
            ...
            geo = st.selectbox("Pilih transformasi:", ["Translasi", "Rotasi", "Flipping", "Zooming"], key="geo_select")

            if geo == "Translasi":
                dx = st.slider("Geser ke kanan (+) atau kiri (-)", -200, 200, 0, key="dx_slider")
                dy = st.slider("Geser ke bawah (+) atau atas (-)", -200, 200, 0, key="dy_slider")
                ...
                angle = st.slider("Pilih sudut rotasi", 0, 360, 90, key="angle_slider")
                ...
                flip = st.radio("Pilih arah flipping", ["Horizontal", "Vertikal"], key="flip_radio")
                ...
                zoom_factor = st.slider("Faktor Zoom", 1.0, 3.0, 1.5, 0.1, key="zoom_slider")
